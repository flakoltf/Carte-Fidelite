...
-- (Onboarding double parcours)
--
-- Migration jumelle du CHECK audit (invariant n°1) : repart de la liste de
-- 20260613_audit_actions_self_service.sql et ajoute les 3 actions du fork
-- concierge. À appliquer EN DERNIER (le test auditActionsSync lit la migration
-- lexicalement la plus récente contenant le CHECK).
