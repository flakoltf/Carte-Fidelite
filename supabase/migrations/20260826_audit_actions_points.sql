...
-- (Carte à points — expiration de cycle, cron quotidien)
--
-- Migration jumelle du CHECK audit (invariant n°1) : repart de la liste de
-- 20260618_audit_actions_demo.sql et ajoute POINTS_EXPIRED. À appliquer EN
-- DERNIER (le test auditActionsSync lit la migration lexicalement la plus
-- récente contenant le CHECK ; ce fichier 20260826_* trie après tous les
